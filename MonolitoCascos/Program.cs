...
class Program
{
    ...
    static void IngresarNuevoCasco(MySqlConnection connection)
    {
        ...
        InsertarCasco(nuevaTalla, nuevaMarca, nuevoPrecio, nuevoComprador, nuevoApellido, nuevaCedula, nuevasUnidades, connection);
    }

    static void InsertarCasco(string talla, string marca, double precio, string comprador, string apellido, string cedula, int unidades, MySqlConnection connection)
    {
        string insertQuery = $"INSERT INTO cascos (talla, marca, precio, comprador, apellido, cedula, unidades) VALUES ('{talla}', '{marca}', {precio}, '{comprador}', '{apellido}', '{cedula}', {unidades})";
